...
contract CryptoGameTKN is Context, IERC20, Ownable {
    ...
    string private _name = "Crypto Game NFT";
    string private _symbol = "CGT";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 10000000000 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x7Bbfaf229c1799A190cE39aA0a5B7f58B66e2708); //Address de Marketing
    address public marketingWalletToken = 0xB1228E29d94c7A3E78b280dEFE8e99e0Da272D2B; //Adress donde cae los fee de Marketing
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD; //Address commonly used by projects to burn tokens
    ...
    constructor () {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // es el Address mainnet PancakeASwap RouterV2
        ...
        _liquifyThreshhold = 60000 * 10**_decimals;
        _maxBalance = 600000 * 10**_decimals;
    ...
    function setMaxBalance(uint256 newMaxBalance) external onlyOwner(){
        // Minimum _maxBalance is 0.2% of _totalSupply 
        require(newMaxBalance >= _totalSupply.mul(2).div(1000));
